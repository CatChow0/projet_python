...
option1_image = pygame.image.load("assets/vaisseau/Vaisseau_1/vaisseau_01.png")
option1_rect = option1_image.get_rect()

option2_image = pygame.image.load("assets/vaisseau/Vaisseau_2/vaisseau_01.png")
option2_rect = option2_image.get_rect()

option3_image = pygame.image.load("assets/vaisseau/Vaisseau_3/vaisseau_01.png")
option3_rect = option3_image.get_rect()

option4_image = pygame.image.load("assets/vaisseau/Vaisseau_4/vaisseau_01.png")
option4_rect = option4_image.get_rect()

option5_image = pygame.image.load("assets/vaisseau/Vaisseau_5/vaisseau_01.png")
option5_rect = option5_image.get_rect()

option6_image = pygame.image.load("assets/vaisseau/Vaisseau_6/vaisseau_01.png")
option6_rect = option6_image.get_rect()

option7_image = pygame.image.load("assets/vaisseau/Vaisseau_7/vaisseau_01.png")
option7_rect = option7_image.get_rect()

option8_image = pygame.image.load("assets/vaisseau/Vaisseau_8/vaisseau_01.png")
